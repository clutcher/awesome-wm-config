...
awful.util.tagnames = { "www", "dev", "term", "text", "pvt" }
...
-- Print screen
        awful.key({                   }, "Print", function()
            awful.util.spawn_with_shell("import -frame ~/screenshots/$(date +%F_%H-%M-%S).png")
        end),
        awful.key({ modkey, }, "Print", function()
            awful.util.spawn_with_shell("import -window root ~/screenshots/$(date +%F_%H-%M-%S).png")
        end),
